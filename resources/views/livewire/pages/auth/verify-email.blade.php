...
<div>
    <x-auth-heading :title="__('Verify your email')"
    ...
    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 rounded-lg bg-green-50 p-3 font-medium text-sm text-green-700">
    ...
    <button wire:click="logout" type="button" class="mt-5 w-full text-center text-sm text-gray-500 hover:text-indigo-600">
        {{ __('Log Out') }}
    </button>
</div>
