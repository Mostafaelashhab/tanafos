<x-marketing-layout :title="__('How it works')" description="كيف يعمل سوق الطلب العكسي: من نشر الطلب إلى إتمام الصفقة.">
    ...
    <section class="max-w-5xl mx-auto px-6 py-10">
        <h2 class="text-2xl font-bold mb-8 flex items-center gap-2"><span class="text-indigo-600"><x-icon name="shopping-bag" class="w-7 h-7" /></span> رحلة المشتري</h2>
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-5xl mx-auto px-6">
            <h2 class="text-2xl font-bold mb-8 flex items-center gap-2"><span class="text-indigo-600"><x-icon name="storefront" class="w-7 h-7" /></span> رحلة التاجر</h2>
            <div class="grid gap-6 md:grid-cols-3">
                @foreach ([
    ...
    <section class="max-w-3xl mx-auto px-6 py-16 text-center">
        ...
        <a href="{{ route('register') }}" class="inline-block px-8 py-3 rounded-full bg-indigo-600 text-white font-bold text-lg hover:bg-indigo-700">أنشئ حسابك مجانًا</a>
    </section>
