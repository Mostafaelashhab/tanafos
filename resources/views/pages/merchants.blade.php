<x-marketing-layout :title="__('For merchants')" description="انضم كتاجر إلى Tanafos: عملاء جاهزون للشراء وتكلفة إعلانات أقل.">
    ...
    <section class="relative overflow-hidden bg-gradient-to-b from-brand-50 to-white">
        <div class="absolute -top-24 -end-24 w-96 h-96 bg-brand-200/40 rounded-full blur-3xl"></div>
        <div class="relative max-w-5xl mx-auto px-6 pt-20 pb-14 text-center">
            <span class="inline-block px-4 py-1.5 rounded-full bg-white/70 ring-1 ring-brand-100 text-brand-700 text-sm font-medium mb-6">للتجار</span>
            <h1 class="text-4xl sm:text-5xl font-extrabold leading-tight">عملاء جاهزون للشراء <span class="text-brand-600">يأتون إليك</span></h1>
            ...
            <a href="{{ route('register') }}" class="mt-8 inline-block px-8 py-3 rounded-full bg-brand-600 text-white font-bold text-lg hover:bg-brand-700">سجّل كتاجر</a>
        </div>
    </section>
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <a href="{{ route('pricing') }}" wire:navigate class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white ring-1 ring-gray-200 font-semibold hover:bg-gray-50">
                <x-icon name="credit-card" class="w-5 h-5 text-brand-600" /> {{ __('See pricing') }}
            </a>
        </div>
    </section>
